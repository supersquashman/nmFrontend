...
export class NmMapService {
  ...
  private rooms: Room[] = [
    ...
    { id: 2, name: "Path Through the Forst", x: 0, y: 1, exits: { south: 1, north: 3 }, description: "Just a room" },
    { id: 3, name: "Eastern Edge of the Forest", x: 0, y: 0, exits: { south: 2, southeast:4 }, description: "Just a room" },
    { id: 4, name: "Deep Forestry", x: 1, y: 1, exits: {northwest: 3, east:5}, description: "Just a room"}
